                    ...
                    <div class="col-lg">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb4">Silahkan Login untuk memasuki halaman Web</h1>
                            </div>
                            ...
                            <div class="text-center">
                                <a class="small" href="<?= base_url('autentifikasi/registrasi'); ?>">Belum punya akun ? Silahkan daftar</a>
                            </div>
                        </div>
                    </div>
                </div>
